...
(function () {
    ...
    w2grid.prototype = {
        ...
        buttons: {
            ...
            'columns'  : { type: 'drop', id: 'w2ui-column-on-off', icon: 'w2ui-icon-columns', hint: w2utils.lang('显示/隐藏 列'), arrow: false, html: '' },
            ...
            'search-go': { type: 'check',  id: 'w2ui-search-advanced', caption: w2utils.lang('搜索...'), hint: w2utils.lang('Open Search Fields') },
            'add'      : { type: 'button', id: 'w2ui-add', caption: w2utils.lang('新增'), hint: w2utils.lang('新增一条记录'), icon: 'w2ui-icon-plus' },
            'edit'     : { type: 'button', id: 'w2ui-edit', caption: w2utils.lang('编辑'), hint: w2utils.lang('编辑选中的记录'), icon: 'w2ui-icon-pencil', disabled: true },
            'delete'   : { type: 'button', id: 'w2ui-delete', caption: w2utils.lang('删除'), hint: w2utils.lang('删除选中的记录'), icon: 'w2ui-icon-cross', disabled: true },
            'save'     : { type: 'button', id: 'w2ui-save', caption: w2utils.lang('保存'), hint: w2utils.lang('保存变更的记录'), icon: 'w2ui-icon-check' }
        },
