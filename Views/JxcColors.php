            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (record) {
                        var rgba = 'FFF';
                        if (record.changes && record.changes.color_rgba) {
                            rgba = record.changes.color_rgba;
                        }
                        return '<div style="height:18px;text-align:center;background-color: #' + rgba + ';">' + ' ' + rgba + '</div>';
                    }
                }
            ],
            show: {
